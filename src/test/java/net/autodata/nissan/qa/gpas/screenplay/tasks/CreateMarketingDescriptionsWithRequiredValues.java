...
public class CreateMarketingDescriptionsWithRequiredValues implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        if (createMarketingDescriptionsInformationList.size() == 1) {
            actor.attemptsTo(

                    RightClick.on(EditModelPage.MARKETING_DESCRIPTIONS_TABLE),
            ...
            else { actor.attemptsTo(RightClick.on(EditModelPage.MARKETING_DESCRIPTIONS_ROW1)); }
